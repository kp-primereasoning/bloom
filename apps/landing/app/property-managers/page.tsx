...
const STEPS = [
  {
    num: "01",
    title: "Bloom activates your property",
    desc: "We set the delivery cadence and assign a local florist. Your team does nothing to make this happen.",
  },
  {
    num: "02",
    title: "Residents subscribe on their own",
    desc: "They sign up, pick a size, and get billed monthly. No involvement from your office.",
  },
  {
    num: "03",
    title: "Track participation in your dashboard",
    desc: "See how many residents are subscribed, delivery status, and engagement over time.",
  },
  {
    num: "04",
    title: "Earn rewards as subscriptions grow",
    desc: "Hit participation milestones and unlock building-level rewards you can redeem for your property.",
  },
]
...
const BENEFITS = [
  {
    ...
    desc: "Bloom handles florist coordination, delivery scheduling, and resident billing. Your team is not in the loop.",
  },
  {
    title: "Real-time delivery visibility",
    desc: "Know when deliveries are scheduled, in progress, and completed. No chasing florists for updates.",
  },
  {
    title: "Rewards that scale with you",
    desc: "The more residents subscribe, the more your building earns. Redeem rewards directly through the platform.",
  },
]
    ...
    <div className="min-h-screen bg-[#FFFBF7] text-bloom-dark">
      ...
      <section className="min-h-[100svh] grid lg:grid-cols-2">
        <div className="flex flex-col justify-center px-8 lg:px-16 pt-32 pb-16 lg:pt-32 lg:pb-0">
          <div ref={heroTextRef}>
            <h1 className="font-serif text-[clamp(3rem,5.5vw,5.5rem)] leading-[1.0] text-[#2C1810] tracking-tight mb-6">
              ...
              your residents<br />
              <em className="not-italic text-bloom-sage">actually use.</em>
            </h1>
            <p className="text-[1.0625rem] text-stone-500 leading-relaxed mb-10 max-w-sm font-light">
              Bloom brings a monthly floral program to your building. You get a dashboard to track it and rewards when your residents engage.
            </p>
            <Button asChild
        ...
        <div className="relative min-h-[50vw] lg:min-h-0">
          <Image
            src="/front_desk.png"
            alt="Property manager handing flowers to a resident"
            fill
      ...
      <section className="border-t border-stone-200 py-14 lg:py-24 bg-[#FFFBF7]">
        <div className="max-w-6xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-[1fr_2fr] gap-6 lg:gap-24 mb-10 lg:mb-16">
            ...
            <p className="reveal font-serif text-2xl md:text-3xl text-stone-800 font-light leading-snug">
              More visibility. Less work. Real rewards.
            </p>
          </div>
          {BENEFITS.map((b, i) => (
            <div key={i} className="reveal grid lg:grid-cols-[1fr_2fr] gap-3 lg:gap-24 py-6 lg:py-8 border-t border-stone-100">
      ...
      <section className="py-20 lg:py-28 bg-[#2C1810] text-white text-center">
        <div className="max-w-xl mx-auto px-6">
          <p className="reveal font-serif text-3xl md:text-4xl lg:text-5xl leading-tight mb-4 font-light">
            Ready to add Bloom to your building?
          </p>
          <p className="reveal text-stone-400 text-[1.0625rem] mb-10 font-light">
            Get in touch and we'll have you live within a week.
          </p>
          <Button asChild
